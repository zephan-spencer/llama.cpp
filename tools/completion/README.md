...
| `--moe-cache-experts N` | keep routed expert weights in host memory and cache N experts per MoE layer on one GPU (default: 0)<br/>(env: LLAMA_ARG_MOE_CACHE_EXPERTS) |
